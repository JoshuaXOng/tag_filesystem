...
use crate::errors::ResultBtAny_;

pub trait PathBufExt {
    fn add_tags(&mut self, to_add: &str) -> ResultBtAny_<()>;
    fn subtract_tags(&mut self, to_subtract: &str) -> ResultBtAny_<()>;
}
...
pub fn get_current_tags(path: &PathBuf) -> ResultBtAny_<impl Iterator<Item = &str>> {
