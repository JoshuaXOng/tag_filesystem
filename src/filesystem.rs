...
use crate::{entries::TfsEntry, errors::{ResultBtAny, ResultBtAny_}, files::{IndexedFiles, TfsFile}, inodes::{FileInode,
...
impl TagFilesystem {
    ...
    pub fn try_new(mount_path: &PathBuf) -> ResultBtAny_<Self> {
    ...
    #[instrument]
    pub fn run_filesystem(mount_path: &PathBuf) -> ResultBtAny_<()> {
...
where Storage: TfsStorage, Snapshots: TfsSnapshots {
    ...
    pub fn get_free_file_inode(&self) -> ResultBtAny_<FileInode> {
    ...
    pub fn get_free_tag_inode(&self) -> ResultBtAny_<TagInode> {
    ...
    pub fn get_file_by_name_and_namespace_inode(&self, file_name: &str,
        namespace_inode: &NamespaceInode) -> ResultBtAny_<&TfsFile>
    {
    ...
    pub fn get_fuser_attributes(&self, inode_id: u64) -> ResultBtAny_<FileAttr> {
    ...
    pub fn get_file_fuser(&self, file_inode: &FileInode) -> ResultBtAny_<FileAttr> {
    ...
    pub fn get_tag_fuser(&self, tag_inode: &TagInode) -> ResultBtAny_<FileAttr> {
    ...
    pub fn get_namespace_fuser(&self, namespace_inode: &NamespaceInode) -> ResultBtAny_<FileAttr> {
    ...
    fn check_tags_exist(&self, to_check: &TagInodes) -> ResultBtAny_<()> {
    ...
    fn check_if_file_is_valid(&self, to_check: &TfsFile) -> ResultBtAny_<()> {
    ...
    fn check_if_tag_is_valid<'a>(&self, tag_inode: impl Into<&'a TagInode>) -> ResultBtAny_<()> {
    ...
    fn check_if_tag_is_valid_(&self, to_check: &TfsTag) -> ResultBtAny_<()> {
    ...
    pub fn add_file(&mut self, to_add: TfsFile) -> ResultBtAny_<&TfsFile> {
        self.check_if_file_is_valid(&to_add)?;
        self.write_to_file(&to_add.inode, 0, &[])?;
        self.files.add(to_add)
    }

    pub fn add_tag(&mut self, to_add: TfsTag) -> ResultBtAny_<&TfsTag> {
    ...
    pub fn rename_tag(&mut self, old_name: &str, new_name: String) -> ResultBtAny_<()> {
    ...
    pub fn insert_namespace(&mut self, namespace_string: String) -> ResultBtAny_<NamespaceInode> {
    ...
    pub fn delete_tag(&mut self, tag_name: &str) -> ResultBtAny_<TfsTag> {
