...
use crate::{entries::TfsEntry, errors::ResultBtAny_, inodes::TagInode, wrappers::write_iter};
...
impl IndexedTags {
    ...
    pub fn get_by_inode_id(&self, inode_id: u64) -> ResultBtAny_<&TfsTag> {
    ...
    pub fn get_free_inode(&self) -> ResultBtAny_<TagInode> {
    ...
    fn will_collide(&self, check_for: &TfsTag) -> ResultBtAny_<()> {
    ...
    pub fn add(&mut self, to_add: TfsTag) -> ResultBtAny_<&TfsTag> {
...
impl<'a, 'b> TagUpdate<'a, 'b> {
    ...
    pub fn try_set_inode(&mut self, inode: TagInode) -> ResultBtAny_<()> {
